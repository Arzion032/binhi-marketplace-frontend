      ...
      <div className="bg-white rounded-3xl shadow-lg w-[1412px] h-[750px] p-10 relative " style={{ marginTop: '90px' }}>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-3 mb-4">
            {[...Array(6)].map((_, i) => (
              <input
                ...
                type="text"
                maxLength={1}
                className="w-[55px] h-[56px] text-center border-2 border-gray-300 rounded-lg text-xl focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            ))}
          </div>
          ...
          <button
            ...
            className="w-[488px] h-[54px] mt-[100px] bg-[#4CAE4F] text-white py-3 rounded-full hover:bg-green-700 transition"
          >
            Next
          </button>
        </div>
